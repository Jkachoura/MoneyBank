...
//    public static String pinCheck(String IBAN) {
//        String query_url = "http://145.24.222.84:5000/pinCheck";
//        String json = "{ \"IBAN\" : \"" + IBAN + "\" }";
//        try {
//            //server Connectie
//            URL url = new URL(query_url);
//            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
...
//    public static String checkBlockStatus(String IBAN) {
//        String query_url = "http://145.24.222.84:5000/checkBlockStatus";
//        String json = "{ \"IBAN\" : \"" + IBAN + "\" }";
//        try {
//            //server Connectie
//            URL url = new URL(query_url);
...
//    public static String blockCard(String IBAN) {
//        String query_url = "http://145.24.222.84:5000/blockCard";
//        String json = "{ \"IBAN\" : \"" + IBAN + "\" }";
//        try {
//            //server Connectie
//            URL url = new URL(query_url);
